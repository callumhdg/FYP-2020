    ...
    <div id="NavBarDiv">
        <nav class="navbar navbar-expand-lg navbar-light bg-white">
            ...
            <div class="container">
                ...
                <div style="padding-left:5%; padding-right:5%; padding-bottom:30px; padding-top:25px; background-color:#e6ffff"">                
                    ...
                    <div style="padding-top:15px">
                        <asp:Button ID="btnSelectClass" Width="100%" CssClass="btn-primary" runat="server" Text="Select Class" OnClick="btnSelectClass_Click"/>
                    </div>
                ...
                <div id="gridViews">
                    ...
                    <div style="padding-left:5%; padding-right:5%; padding-bottom:30px; padding-top:30px; background-color:white">
                <span style="font-weight:bold">Students Not In Selected Class</span><br/>
                <asp:GridView ID="allOtherStudents" DataSourceID="ViewAllStudentsNotInClass" runat="server" DataKeyNames="StudentID" AutoGenerateColumns="False"  RowStyle-BackColor="White" HeaderStyle-BackColor="White">
                    <Columns>
                        ...
                        <asp:TemplateField>
                            <ItemTemplate>
                                ...
                                <asp:Button ID="btnAdd" runat="server" OnClick="btnAdd_Click" CssClass="btn-success" HeaderText="Add Student To Class" ShowHeader="True" Text="Add" ItemStyle-HorizontalAlign="Center" CommandArgument="Container.DataItemIndex" />  <%--CommandArgument="Container.DataItemIndex"--%>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
                </asp:GridView>
                    ...
                    <div style="padding-left:5%; padding-right:5%; padding-bottom:30px; padding-top:30px; background-color:#e6ffff">
                <span style="font-weight:bold">Students In Selected Class</span><br/>
                <asp:GridView ID="allStudentsInClass" DataSourceID="ViewAllStudentsInClass" runat="server" DataKeyNames="StudentID" AutoGenerateColumns="false"  RowStyle-BackColor="White" HeaderStyle-BackColor="White">
                    <Columns>
                        <asp:BoundField DataField="StudentID" ReadOnly="true"/>
                        <asp:BoundField DataField="StudentUsername" HeaderText="Student Username" ReadOnly="true" SortExpression="StudentUsername"/>
                        <asp:BoundField DataField="StudentFirstName" HeaderText="Student First Name" ReadOnly="true" SortExpression="StudentFirstName"/>
                        ...
                        <asp:TemplateField>
                            <ItemTemplate>                                
                                <asp:Button ID="btnRemove" runat="server" OnClick="btnRemove_Click" CssClass="btn-danger" CommandName="Select" HeaderText="Remove Student From Class" ShowHeader="True" Text="Remove" ItemStyle-HorizontalAlign="Center" /> <%--CommandArgument="Container.DataItemIndex"--%>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
                </asp:GridView>
