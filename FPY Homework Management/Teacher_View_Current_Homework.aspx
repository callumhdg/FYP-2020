...
<body style="background-color:#F8F8F8;">
    ...
    <form id="frmViewIssuedHomework" runat="server">
        <div>
            ...
            <asp:Button ID="btnSubmitMarkedHomework" runat="server" Text="Submit" OnClick="btnSubmitMarkedHomework_Click" CssClass="btn btn-success btn-block" Style="margin-top:8px; margin-left:0px; margin-right:0px;"/>
