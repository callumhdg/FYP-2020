<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Student_View_Marked_Homework.aspx.cs" Inherits="FPY_Homework_Management.Student_View_Marked_Homework" %>
...
<body style="background-color:#F8F8F8;">
    ...
    <form id="frmViewMarkedHomework" runat="server" style="margin-bottom:40px">
        <div>
            ...
            <div id="q1Conainer" runat="server" class="container" style="background-color:#e6ffff; padding:8px;">
                ...
                <div class="row" style="width:100%; padding-left:5%; padding-right:5%; padding-top:30px; padding-bottom:10px; margin:0px">
                    ...
                    <label id="txtQ1Marks" runat="server" class="form-control"></label>
                </div>
                ...
                <div class="row" style="width:100%; padding-left:5%; padding-right:5%; margin:0px">
                    ...
                    <asp:TextBox ID="txtQ1Feedback" runat="server" class="form-control" placeholder="Feedback" ReadOnly="true"></asp:TextBox>
                </div><br/>
            </div>
            ...
            <div id="q2Conainer" runat="server" class="container" style="background-color:white; padding:8px;">
                ...
                <div class="row" style="width:100%; padding-left:5%; padding-right:5%; padding-top:30px; padding-bottom:10px; margin:0px">
                    ...
                    <label id="txtQ2Marks" runat="server" class="form-control"></label>
                </div>

                <div class="row" style="width:100%; padding-left:5%; padding-right:5%; margin:0px">
                    <span>Quesion 2 Feedback</span>
                    <asp:TextBox ID="txtQ2Feedback" runat="server" class="form-control" placeholder="Feedback" ReadOnly="true"></asp:TextBox>
                </div><br/>
            </div>
            ...
            <div id="q3Conainer" runat="server" class="container" style="background-color:#e6ffff; padding:8px;">
                ...
                <div class="row" style="width:100%; padding-left:5%; padding-right:5%; padding-top:30px; padding-bottom:10px; margin:0px">
                    ...
                    <label id="txtQ3Marks" runat="server" class="form-control"></label>
                </div>

                <div class="row" style="width:100%; padding-left:5%; padding-right:5%; margin:0px">
                    <span>Quesion 3 Feedback</span>
                    <asp:TextBox ID="txtQ3Feedback" runat="server" class="form-control" placeholder="Feedback" ReadOnly="true"></asp:TextBox>
                </div><br/>
            </div>
            ...
            <div id="q4Conainer" runat="server" class="container" style="background-color:white; padding:8px;">
                ...
                <div class="row" style="width:100%; padding-left:5%; padding-right:5%; padding-top:30px; padding-bottom:10px; margin:0px">
                    ...
                    <label id="txtQ4Marks" runat="server" class="form-control"></label>
                </div>

                <div class="row" style="width:100%; padding-left:5%; padding-right:5%; margin:0px">
                    <span>Quesion 4 Feedback</span>
                    <asp:TextBox ID="txtQ4Feedback" runat="server" class="form-control" placeholder="Feedback" ReadOnly="true"></asp:TextBox>
                </div><br/>
            </div>
            ...
            <div id="q5Conainer" runat="server" class="container" style="background-color:#e6ffff; padding:8px;">
                ...
                <div class="row" style="width:100%; padding-left:5%; padding-right:5%; padding-top:30px; padding-bottom:10px; margin:0px">
                    ...
                    <label id="txtQ5Marks" runat="server" class="form-control"></label>
                </div>

                <div class="row" style="width:100%; padding-left:5%; padding-right:5%; margin:0px">
                    <span>Quesion 5 Feedback</span>
                    <asp:TextBox ID="txtQ5Feedback" runat="server" class="form-control" placeholder="Feedback" ReadOnly="true"></asp:TextBox>
                </div><br/>
            </div>
            ...
            <div id="q6Conainer" runat="server" class="container" style="background-color:white; padding:8px;">
                ...
                <div class="row" style="width:100%; padding-left:5%; padding-right:5%; padding-top:30px; padding-bottom:10px; margin:0px">
                    ...
                    <label id="txtQ6Marks" runat="server" class="form-control"></label>
                </div>

                <div class="row" style="width:100%; padding-left:5%; padding-right:5%; margin:0px">
                    <span>Quesion 6 Feedback</span>
                    <asp:TextBox ID="txtQ6Feedback" runat="server" class="form-control" placeholder="Feedback" ReadOnly="true"></asp:TextBox>
                </div><br/>
            </div>
            ...
            <div id="q7Conainer" runat="server" class="container" style="background-color:#e6ffff; padding:8px;">
                ...
                <div class="row" style="width:100%; padding-left:5%; padding-right:5%; padding-top:30px; padding-bottom:10px; margin:0px">
                    ...
                    <label id="txtQ7Marks" runat="server" class="form-control"></label>
                </div>

                <div class="row" style="width:100%; padding-left:5%; padding-right:5%; margin:0px">
                    <span>Quesion 7 Feedback</span>
                    <asp:TextBox ID="txtQ7Feedback" runat="server" class="form-control" placeholder="Feedback" ReadOnly="true"></asp:TextBox>
                </div><br/>
            </div>
            ...
            <div id="q8Conainer" runat="server" class="container" style="background-color:white; padding:8px;">
                ...
                <div class="row" style="width:100%; padding-left:5%; padding-right:5%; padding-top:30px; padding-bottom:10px; margin:0px">
                    ...
                    <label id="txtQ8Marks" runat="server" class="form-control"></label>
                </div>

                <div class="row" style="width:100%; padding-left:5%; padding-right:5%; margin:0px">
                    <span>Quesion 8 Feedback</span>
                    <asp:TextBox ID="txtQ8Feedback" runat="server" class="form-control" placeholder="Feedback" ReadOnly="true"></asp:TextBox>
                </div><br/>
            </div>
            ...
            <div id="q9Conainer" runat="server" class="container" style="background-color:#e6ffff; padding:8px;">
                ...
                <div class="row" style="                        width: 100%;
                    ...
                    <label id="txtQ9Marks" runat="server" class="form-control"></label>
                </div>

                <div class="row" style="width:100%; padding-left:5%; padding-right:5%; margin:0px">
                    <span>Quesion 9 Feedback</span>
                    <asp:TextBox ID="txtQ9Feedback" runat="server" class="form-control" placeholder="Feedback" ReadOnly="true"></asp:TextBox>
                </div><br/>
            </div>
            ...
            <div id="q10Conainer" runat="server" class="container" style="background-color:white; padding:8px;">
                ...
                <div class="row" style="width:100%; padding-left:5%; padding-right:5%; padding-top:30px; padding-bottom:10px; margin:0px">
                    ...
                    <label id="txtQ10Marks" runat="server" class="form-control"></label>
                </div>

                <div class="row" style="width:100%; padding-left:5%; padding-right:5%; margin:0px">
                    <span>Quesion 10 Feedback</span>
                    <asp:TextBox ID="txtQ10Feedback" runat="server" class="form-control" placeholder="Feedback" ReadOnly="true"></asp:TextBox>
                </div><br/>
            </div>
            ...
            <div class="container" style="padding:8px;">                
                <asp:Button ID="btnReturnHome" runat="server" Text="Return Home" OnClick="btnReturnHome_Click" CssClass="btn btn-secondary btn-block" style="width:100%; padding-left:5%; padding-right:5%; margin-bottom:0px; margin-left:0px; margin-right:0px; margin-top:8px"/>
            </div>
        </div>
    </form>
</body>
