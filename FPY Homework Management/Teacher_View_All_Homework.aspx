<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Teacher_View_All_Homework.aspx.cs" Inherits="FPY_Homework_Management.Teacher_View_All_Homework" %>
...
<body style="background-color:#F8F8F8">
    ...
    <form id="frmViewAllHomework" runat="server" style="margin:0px; border:0px;">
    ...
    <div id="NavBarDiv">
        ...
        <div style="margin-left:3%; margin-bottom:5%; margin-top:3%; margin-right:3%; width:70%;">            
            ...
            <asp:SqlDataSource ID="listAllHomework" runat="server" ConnectionString="<%$ ConnectionStrings:PRCO304_CHarding %>" SelectCommand="SELECT * FROM CoreHomework"></asp:SqlDataSource>

            <asp:GridView ID="viewIssuedHomework" runat="server" DataSourceID="listAllHomework" DataKeyNames="CoreHomeworkID" AutoGenerateColumns="false" RowStyle-BackColor="White" HeaderStyle-BackColor="White">
                <Columns>
                    <asp:BoundField DataField="CoreHomeworkID" ReadOnly="true"/>
                    <asp:BoundField DataField="HomeworkTitle" HeaderText="Homework Title" ReadOnly="true"/>
                    <asp:TemplateField>
                        <ItemTemplate>                                
